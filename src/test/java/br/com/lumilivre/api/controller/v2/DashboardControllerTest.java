...
@Import({I18nConfig.class, MessageResolver.class, DashboardMapper.class, EnumLabelResolver.class})
...
class DashboardControllerTest {
    ...
    void statsReturnsPtBRContentLanguage() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/dashboard/stats").header("Accept-Language", "pt-BR"))
    ...
    void statsReturnsEnUSContentLanguage() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/dashboard/stats").header("Accept-Language", "en-US"))
                .andExpect(status().isOk())
    ...
    void topBooksReturnsList() throws Exception {
        when(dashboardService.getTopLivros()).thenReturn(List.of());

        mockMvc.perform(get("/api/v2/dashboard/top-books").header("Accept-Language", "pt-BR"))
                .andExpect(status().isOk())
                .andExpect(header().string("Content-Language", "pt-BR"))
