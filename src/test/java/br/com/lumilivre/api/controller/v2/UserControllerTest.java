...
import br.com.lumilivre.api.mapper.v2.UserMapper;
...
class UserControllerTest {
    ...
    void listReturnsPtBRContentLanguage() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/users").header("Accept-Language", "pt-BR"))
    ...
    void listReturnsEnUSContentLanguage() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/users").header("Accept-Language", "en-US"))
                .andExpect(status().isOk())
