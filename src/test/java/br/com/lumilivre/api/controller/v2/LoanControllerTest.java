...
import br.com.lumilivre.api.mapper.v2.LoanMapper;
...
class LoanControllerTest {
    ...
    void listReturnsPtBRWithEnFieldNames() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/loans").header("Accept-Language", "pt-BR"))
    ...
    void listReturnsEnUSLabels() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/loans").header("Accept-Language", "en-US"))
                .andExpect(status().isOk())
