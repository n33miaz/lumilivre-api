...
--  rodape do e-mail no mesmo idioma do assunto/corpo ja resolvidos.
...
COMMENT ON COLUMN outbox_event.locale IS
    'BCP-47 language tag captured at publish time so the async sender renders the email shell in the recipient locale.';
